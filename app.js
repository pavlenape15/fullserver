...
function movieSection(movies)
{
    return movies.map((movie) => {
        ...
        {
            document.querySelector(".mySwiper2 .swiper-wrapper").innerHTML += `<img width="300px" class="TrendingMovie swiper-slide" src="https://image.tmdb.org/t/p/w500/${movie.poster_path}" data-movie-name="${movie.original_title}"  data-movie-id="${movie.id}" /> `;
        }
    })
}


function movieSectionTrending(movies)
{
    return movies.map((movie) => {
        if(movie.poster_path)
        {
            document.querySelector(".mySwiper3 .swiper-wrapper").innerHTML += `<img width="300px" class="TrendingMovie swiper-slide" src="https://image.tmdb.org/t/p/w500/${movie.poster_path}" data-movie-name="${movie.original_title}"  data-movie-id="${movie.id}" /> `;
        }
    })
}
...
function renderTrendingMovies(data){
    const movies = data.results
        ...
        let moviesToAdd = movieSectionTrending(movies);
        moviesToAdd.forEach((mov) => {
            console.log(mov)
            // document.querySelector(".mySwiper2 .swiper-wrapper").appendChild(mov);
        })
    ...
    <div class="content"> 
        <div class="links">
            ...
            <div class="streaming-links">
                <div class="streaming-div"><a class="streaming" href="https://solarmovie.pe/home"> SOLARMOVIE EN </a></div>
                <div class="streaming-div"><a class="streaming" href="https://kinokong.pro/"> KINOKONG RU </a></div>
                <div class="streaming-div"><a class="streaming" href="https://kinogo.biz/"> KINOGO RU </a></div>
                <div class="streaming-div"><a class="streaming" href="https://www.cavea.ge/"> CAVEA GE </a></div>
            </div>
        </div>
    </div>
    `
...
document.onclick = function(event){
    ...
    const Url2 = "https://api.themoviedb.org/3/trending/all/week?api_key=07f4c56ff64392836837181739598358"
